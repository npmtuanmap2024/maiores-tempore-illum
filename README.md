...
[![NPM](https://img.shields.io/npm/v/@npmtuanmap2024/maiores-tempore-illum)](https://www.npmjs.com/package/@npmtuanmap2024/maiores-tempore-illum)
[![NPM](https://img.shields.io/npm/dt/@npmtuanmap2024/maiores-tempore-illum)](https://www.npmjs.com/package/@npmtuanmap2024/maiores-tempore-illum)
[![NPM](https://img.shields.io/npm/types/@npmtuanmap2024/maiores-tempore-illum)](https://www.npmjs.com/package/@npmtuanmap2024/maiores-tempore-illum)

## Install:

You can use this automatically in the browser with the [userscript](https://github.com/npmtuanmap2024/maiores-tempore-illum/wiki/Userscript).

-   [Node Package Manager](https://github.com/npmtuanmap2024/maiores-tempore-illum/wiki/Node-Package) (NPM)
-   [Browser](https://github.com/npmtuanmap2024/maiores-tempore-illum/wiki/Userscript) (userscript)
-   [jsDelivr](https://github.com/npmtuanmap2024/maiores-tempore-illum/wiki/jsDelivr)

## NodeJS

```
npm install @npmtuanmap2024/maiores-tempore-illum
```

### Require

```js
import { TidyURL } from '@npmtuanmap2024/maiores-tempore-illum';
// or
const { TidyURL } = require('@npmtuanmap2024/maiores-tempore-illum');
```
...
By default, @npmtuanmap2024/maiores-tempore-illum will remove redirect parameters and AMP links if the rule supports it.  
...
_More info about AMP on [the wiki](https://github.com/npmtuanmap2024/maiores-tempore-illum/wiki/AMP-Links)_.
...
You can view all custom supported sites [here](https://github.com/npmtuanmap2024/maiores-tempore-illum/wiki/Supported-Sites).  
...
Request direct support for a website [here](https://github.com/npmtuanmap2024/maiores-tempore-illum/issues/new?assignees=&labels=&template=add-website.md&title=Website%3A+example.com)
...
Feel free to check [issues page](https://github.com/npmtuanmap2024/maiores-tempore-illum/issues).
